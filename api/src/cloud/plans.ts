...
export class CloudPlaylists extends CloudDocuments<CloudMusicPlaylist, MusicPlaylist> {
  constructor(store: BlobStore, auth: CloudAuth, readonly media: CloudMedia) { super(store, auth, 'playlist'); }
...
export class CloudClasses extends CloudDocuments<CloudClassSetup, ClassSetup> {
  readonly fillers: CloudFillers;
  constructor(store: BlobStore, auth: CloudAuth, readonly routines: CloudRoutines, readonly playlists: CloudPlaylists) {
    super(store, auth, 'class');
